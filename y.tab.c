...
{
       0,    56,    56,    58,    62,    63,    66,    67,    70,    74,
      82,    83,    86,    91,    86,   104,   104,   106,   107,   110,
     115,   129,   129,   136,   137,   139,   140,   142,   143,   144,
     145,   146,   148,   149,   152,   153,   153,   159,   168,   166,
     176,   180,   182,   196,   200,   203,   205,   214,   218,   222,
     222,   222,   222,   222,   222,   224,   228,   231,   232,   235,
     239,   242,   243,   246,   247,   252,   253,   258,   265,   265,
     267,   268
};
#endif
...
#line 1443 "y.tab.c"
  ...
  case 8:
#line 70 "cminus.y"
                                        {insertSym((yyvsp[-1].s), parsedSymbolAttributes, VAR);
...
#line 74 "cminus.y"
                                                    {parsedSymbolAttributes.array = 1;
                                                     parsedSymbolAttributes.arrSize = (yyvsp[-2].n);
                                                     insertSym((yyvsp[-4].s), parsedSymbolAttributes, VAR);
                                                     strcpy((yyval.s), (yyvsp[-4].s));
                                                     resetparsedSymbolAttributes();
                                                    }
#line 1463 "y.tab.c"
    break;
...
#line 86 "cminus.y"
                                            {if(!TextSection++) fprintf(fp, "\nSECTION .text\nextern printf\n");
                                             emitDeclaration(FUNC, (yyvsp[-1].s));
                                             /*funcBody = 1;*/
                                             initializeScope();
                                            }
#line 1485 "y.tab.c"
  ...
  case 13:
#line 91 "cminus.y"
                                            {parsedSymbolAttributes.type = (yyvsp[-5].n);
                                             parsedSymbolAttributes.parameters = NumOfParams;
                                             insertGlobalSym((yyvsp[-4].s), parsedSymbolAttributes, FUNC);
											                       resetparsedSymbolAttributes();
                                             NumOfParams=0;
											                      }
#line 1496 "y.tab.c"
...
#line 110 "cminus.y"
                                    {parsedSymbolAttributes.parameters = NumOfParams + 1;
                                     ...
                                     insertSym((yyvsp[0].s), parsedSymbolAttributes, VAR);
                                     resetparsedSymbolAttributes();
                                    }
#line 1528 "y.tab.c"
    break;
...
#line 115 "cminus.y"
                                    {parsedSymbolAttributes.parameters = NumOfParams + 1;
                                     parsedSymbolAttributes.array = 1;
                                     parsedSymbolAttributes.initialized = 1;
                                     insertSym((yyvsp[-2].s), parsedSymbolAttributes, VAR);
                                     resetparsedSymbolAttributes();
                                    }
#line 1539 "y.tab.c"
    break;
...
#line 196 "cminus.y"
                                    {(yyval.n)=9;
                                     emitMemOp(STORE,(yyvsp[-2].s),(yyvsp[0].n));
                                     releaseOneRegister();
                                    }
#line 1646 "y.tab.c"
    break;
...
#line 1652 "y.tab.c"
  ...
  case 45:
#line 203 "cminus.y"
                            {lookUpSym((yyvsp[0].s))->attr.references++; strcpy((yyval.s), (yyvsp[0].s));}
#line 1658 "y.tab.c"
    break;

  case 46:
#line 205 "cminus.y"
                            {struct symbolEntry *tmp = lookUpSym((yyvsp[-3].s));
                             if(!tmp->attr.array)
                             printf("error - %s is not an array", tmp->id);
                             tmp->attr.references++;
                             tmp->attr.regContainingArrIndex = (yyvsp[-1].n);
...
#line 214 "cminus.y"
                                                                   {(yyval.n)=(yyvsp[-2].n);
                                                                    emitRelOp((yyvsp[-1].n),(yyvsp[-2].n),(yyvsp[0].n));
                                                                    releaseOneRegister();
                                                                   }
#line 1679 "y.tab.c"
    break;
...
#line 224 "cminus.y"
                                                        {(yyval.n) = (yyvsp[-2].n);
                                                         emitAluOp((yyvsp[-1].n),(yyvsp[-2].n),(yyvsp[0].n));
                                                         releaseOneRegister();
                                                        }
#line 1731 "y.tab.c"
    break;
...
#line 247 "cminus.y"
                            {
                             ...
                             emitMemOp(LOAD,(yyvsp[0].s),(yyval.n));
                            }
#line 1791 "y.tab.c"
    break;
...
#line 253 "cminus.y"
                            {(yyval.n)=nextFreeRegister();
                             emitLoadConst((yyval.n), (yyvsp[0].n));
                            }
#line 1805 "y.tab.c"
    break;
